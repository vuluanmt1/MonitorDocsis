...
public class ModelNodeCurrent {
    ...
    public ModelNodeCurrent(String node, String ifdesc, String snr, String mer, String fec, String unfec, String tx, String rx, String act, String total, String reg, String fre, String wth, String micref, String mod, String time, String cmtsid, String ifindex) {
        this.node = node;
        this.ifdesc = ifdesc;
        this.snr = snr;
        this.mer = mer;
