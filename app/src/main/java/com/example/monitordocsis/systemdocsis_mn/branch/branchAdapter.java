package com.example.monitordocsis.systemdocsis_mn.branch;
...
public class branchAdapter extends ArrayAdapter<branchModel> {
    public branchAdapter(@NonNull Context context, List<branchModel>mListBranch) {
        super(context, 0, mListBranch);
    }
