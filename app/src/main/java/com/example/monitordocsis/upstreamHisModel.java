...
public class upstreamHisModel {
    ...
    public upstreamHisModel(String snr, String mer, String fec, String unfec, String txpower, String rxpower, String act, String total, String reg, String fre, String with, String modifileDate, String cmtsid, String ifindex) {
        this.snr = snr;
        this.mer = mer;
        this.fec = fec;
        this.unfec = unfec;
